...
{ ?> 
       <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox chek_confirmed">
          <input type="checkbox" class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" name="terms" <?php checked( apply_filters( 'woocommerce_terms_is_checked_default', isset( $_POST['terms'] ) ), true ); ?> id="terms" /> <span>Я прочитал и принимаю условия <a href="http://printblog.ru/politika" class="woocommerce-terms-and-conditions-link">политики конфидециальности</a></span>
      </label>
...
function wc_change_status_handler($order_id, $checkout=null) {
   ...
   if($order->status === 'processing')
   {
      ...
      if (strpos ($data_array[MDLNAME], "4620") ==false and strpos ($data_array[MDLNAME], "3550") ==false)
      if ($_SLN==10) $data_array[SN] .= ".....";  //если в серийнике укзано 10 символов, добавляем 5 точек
